...
products = [
    ...
    {'id': 6,  'name': 'A4 Paper Pack',       'price': 299,  'category': 'Stationery',  'in_stock': True },
    {'id': 10, 'name': 'Desk Organizer',      'price': 399,  'category': 'Stationery',  'in_stock': True },
    {'id': 11, 'name': 'Keyboard',            'price': 699,  'category': 'Electronics', 'in_stock': False},
]
